    ...
    <div className="feedback-result">
      <div className="feedback-container">
        ...
        <div className="ai-question">
          <h4>질문</h4>
          <p className="question">프로젝트에서 마주했던 가장 어려운 문제는 무엇이었으며, 어떻게 해결했나요?</p>
          <h4>사용자 답변</h4>
          <p className="answer">저는 이 회사가 꿈꾸던 곳이라서 지원했습니다.
            그리고 이 회사에서 더 나은 사람이 되기를 원합니다. 또한 제 역량이 
            이 회사에 잘 맞을 것 같아서 지원하게 되었습니다. 
            그런 점에서 회사와 저의 가치가 잘 맞는다고 생각합니다.</p>
          <h4>주요 피드백</h4>
          <div className="main-feedback">
            <p>1. 말의 속도는 일정하게 유지되고 있으며 적절한 속도입니다.</p>
            <p>2. 전반적으로 목소리의 크기는 일정하게 유지되고 있습니다.</p>
            <p>3. 발음이 대체적으로 정확합니다.</p>
            <p>4. 총 녹음 시간인 5.088초 동안, 답변 중 약간의 휴지 구간이 있었습니다. 연습을 통해 개선할 수 있습니다.</p>
